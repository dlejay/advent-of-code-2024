...
Addition of two binary numbers goes like this:

* Step 0: z00 = x00 + y00; r00 = x00 * y00;
* Step n: zn = xn + yn + r(n-1); rn = (xn + yn) v ((xn+yn) * r(n-1))

Where '+' is XOR, 'v' is OR and '\*' is AND. 

Then sorting the operations by output, will show you most of the pairs to change.
